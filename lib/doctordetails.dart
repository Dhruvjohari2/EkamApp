...
class DoctorDetails extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DoctorDetails> createState() => _HomeScreenState();
}

class _HomeScreenState extends ConsumerState<DoctorDetails> {
            ...
            Row(
              children: [
                Container(
                  ...
                  child: CircleAvatar(
                    radius: 48,
                    backgroundImage: NetworkImage(res.value![widget.id].image),
                  ),
                ),
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: Text(
                          res.value![widget.id].doctorName,
                      ...
                      SizedBox(
                        width: MediaQuery.of(context).size.width * 0.5,
                        child: Text(
                          res.value![widget.id].speciality,
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(
                            width: MediaQuery.of(context).size.width * 0.5,
                            child: Text(res.value![widget.id].location),
                          ),
                        ],
                      ),
                    ],
                ...
                children: [
                  Column(
                    children: [
                      ...
                      Text(
                        '${res.value![widget.id].patientsServed}+',
                        style: const TextStyle(
                            color: Colors.blue,
                            fontSize: 18,
                  ...
                  Column(
                    children: [
                      ...
                      Text(
                        '${res.value![widget.id].yearsOfExperience}+',
                        style: const TextStyle(
                            color: Colors.blue,
                            fontSize: 18,
                            fontWeight: FontWeight.w700),
                  ...
                  Column(
                    children: [
                      ...
                      Text(
                        '${res.value![widget.id].numberOfReviews}+',
                        style: const TextStyle(
                            color: Colors.blue,
                            fontSize: 18,
                            fontWeight: FontWeight.w700),
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) => SelectPackage(
                      date: _date[_dateIndex],
                      time: timeData[_timeIndex],
                      name: res.value![0].doctorName,
                      image: res.value![0].image,
                      speciality: res.value![0].speciality,
                      location: res.value![0].location,
                    ),
                  ),
                );
              },
              child: const Text('Make Appointments'),
            ),
          ],
        ),
      ),
